    ...
    <div>
      ...
      <nav className={`nav-menu ${isMenuOpen ? 'active' : ''}`}>
        <ul>
          ...
          <li><Link className="nav-link" href="/#section2" scroll={true} onClick={closeMenu}>Case Studies</Link></li>
          <li><Link className="nav-link" href="/#section3" scroll={true} onClick={closeMenu}>About</Link></li>
